...
INSERT INTO work_orders (id, organization_id, property_id, client_id, vendor_id, work_order_number, title, description, category, priority, status, estimated_cost, scheduled_date, completed_at, completion_notes) VALUES
  (
