...
## Objective
Create React Query hooks for vendor CRUD operations, search, and filtering. These hooks provide the data layer for vendor management.

## Why This Plan
Vendors need comprehensive data operations:
- List vendors with filters
- Create new vendors
- Update vendor information
- Update vendor compliance (licenses, insurance)
- Search vendors by trade category for work order assignment
...
## Verification
- [ ] useVendors fetches list with all filter options
- [ ] useVendor fetches single vendor with computed stats
- [ ] useVendorsByTrade fetches vendors for a specific trade category
- [ ] useSearchVendors searches vendors by name with optional category filter
- [ ] useCreateVendor creates vendor with organization_id
- [ ] useUpdateVendor updates vendor fields
- [ ] useUpdateVendorCompliance updates compliance-specific fields
- [ ] useToggleVendorPreferred toggles preferred status
- [ ] useDeactivateVendor soft deletes vendor
- [ ] useReactivateVendor restores vendor
- [ ] useRateVendor calculates and updates average rating
- [ ] useVendorComplianceCounts returns compliance statistics
