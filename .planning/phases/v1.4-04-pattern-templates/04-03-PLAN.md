...
**Scope note:** This plan covers PORTAL pages only (SYNC-08.4). Admin pages (SYNC-07.5, SYNC-08.5) are deferred to v1.5 to keep this phase focused. The patterns established here will serve as templates for admin page updates.
</objective>
...
<deferred>
**Admin pages (SYNC-07.5, SYNC-08.5) are OUT OF SCOPE for this phase.**

Rationale: Keeping phase focused on establishing patterns in portal first. Admin pages will be updated in v1.5 using the same patterns established here.

Tracking: Add to v1.5 backlog:
