        ...
        sections: [
          {
            ...
            order: 1,
            items: [
              { id: 'roof', label: 'Roof condition', item_type: 'boolean', required: true },
              { id: 'gutters', label: 'Gutters and downspouts', item_type: 'boolean', required: true },
              { id: 'siding', label: 'Siding/exterior walls', item_type: 'boolean', required: true },
              { id: 'windows_ext', label: 'Windows and screens', item_type: 'boolean', required: true },
              { id: 'doors_ext', label: 'Entry doors', item_type: 'boolean', required: true },
              { id: 'landscaping', label: 'Landscaping', item_type: 'boolean', required: true },
              { id: 'driveway', label: 'Driveway/walkways', item_type: 'boolean', required: true },
            ],
          },
          {
            id: 'interior',
            ...
            order: 2,
            items: [
              { id: 'hvac', label: 'HVAC operation', item_type: 'boolean', required: true },
              { id: 'plumbing', label: 'Plumbing (run water, check for leaks)', item_type: 'boolean', required: true },
              { id: 'electrical', label: 'Electrical (lights, outlets)', item_type: 'boolean', required: true },
              { id: 'smoke_detectors', label: 'Smoke/CO detectors', item_type: 'boolean', required: true },
              { id: 'water_heater', label: 'Water heater', item_type: 'boolean', required: true },
              { id: 'appliances', label: 'Kitchen appliances', item_type: 'boolean', required: true },
              { id: 'floors', label: 'Flooring condition', item_type: 'boolean', required: true },
            ],
          },
          {
            id: 'security',
            ...
            order: 3,
            items: [
              { id: 'locks', label: 'Door locks functional', item_type: 'boolean', required: true },
              { id: 'alarm', label: 'Alarm system', item_type: 'boolean', required: false },
              { id: 'cameras', label: 'Security cameras', item_type: 'boolean', required: false },
              { id: 'motion_lights', label: 'Motion lights', item_type: 'boolean', required: false },
            ],
          },
        ],
      }
